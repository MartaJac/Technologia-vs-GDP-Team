...
- Przygotowanie możliwość przeglądania danych źródłowych, np. excel
...
**3. Dwie osoby odpowiedzialne za przygotowanie danych w bazie danych (MySQL) (każda do jednego tematu) (Marta i Adrian):**
